#!/usr/bin/env python3
"""
Stoiximan Live Odds Scraper
Scrapes live betting odds from stoiximan.gr for cash-out analysis
"""
...
logger = logging.getLogger("stoiximan_scraper")
...
class StoiximanScraper:
    """Scraper for Stoiximan live odds"""
    
    BASE_URL = "https://www.stoiximan.gr"
    API_URL = "https://www.stoiximan.gr/api/v1/live/events"
    ...
    def __init__(self, session: aiohttp.ClientSession = None):
        ...
        self.headers = {
            ...
            "Referer": "https://www.stoiximan.gr/live/",
        }
    ...
    def _parse_matches(self, data: Dict) -> List[LiveMatch]:
    ...
    async def get_match_by_teams(self, home: str, away: str) -> Optional[LiveMatch]:
    ...
    def get_cached_match(self, match_id: str) -> Optional[LiveMatch]:
        """Get match from cache"""
        return self.matches.get(match_id)
    
    def save_to_file(self, filepath: str = None):
        """Save matches to JSON"""
        filepath = filepath or "/root/.openclaw/workspace/cashout_system/data/stoiximan_live.json"
...
async def main():
    """Test scraper"""
    async with StoiximanScraper() as scraper:
